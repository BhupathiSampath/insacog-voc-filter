<template>
  <div>
    <div class="relative flex justify-center items-center w-full border-b-2 border-gray-300 my-20 mt-6 mb-6">
      <h1 class="absolute bg-white px-2 text-xl font-semibold">INSACOG QueryHub Stats</h1>
    </div>
    <div v-if="datatable_loaded"
    ...
    <div v-show="isShowing" class="inset-10 bg-white w-full pl-4 pb-2" id="lineage-model">
      <div
...
export default {
  ...
  computed: { ...mapFields('base', ['datatable', 'datatable_loaded','uniqueLineages', 'uniqueLineages_loaded','lineageDistribution', 
    'lineageDistribution_loaded','uniqueSequences', 'uniqueSequences_loaded']) },
  methods: {
    formatnumber(value) {
