<template>
	<div>
		<div class="relative flex justify-center items-center w-full border-b-2 border-gray-300 my-20">
			<h1 class="absolute bg-white px-2 text-xl font-semibold">INSACOG QueryHub</h1>
		</div>
