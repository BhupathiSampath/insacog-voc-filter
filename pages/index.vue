<template>
  <div>
    ...
    <div>
      ...
      >
        ...
        <div class="grid justify-items-end">
          ...
          >
            <i class="fa fa-filter" style="font-size: 24px"></i>Filter
          </button>
        </div>
      </div>
    </div>
    ...
    <div class="fixed hidden w-80 mx-auto mt-5 p-7 grid justify-end" id="loader">
      <div class="grid justify-items-center">
        <div class="fixed w-80 mx-auto mt-5 p-7">
          Loading....<cube-spin></cube-spin>
        </div>
      </div>
    </div>
...
<script>
import CubeSpin from "/home/nsm-07/Desktop/Bhupati/dev/insacog-voc-filter/components/Cube.vue";
...
export default {
  ...
  async asyncData() {
    ...
    const nextclade_version = version_data.data.nextclade_version
      ...
      .split(":")
      .at(-1);
    const pango_designation_version =
      version_data.data.pango_designation_version.toString().split(":").at(-1);
  ...
  methods: {
    ...
    async fetchSomething() {
      ...
      const lineagescount = await axios.get(
        `${process.env.baseUrl}/uniqelineagecount/?search=${this.search}&start_date=${this.start_date}&end_date=${this.end_date}&strain=${this.strain}&state=${this.state}&lineage=${this.lineage}&mutation_deletion=${this.mutation_deletion}&date=${this.date}&gene=${this.gene}&reference_id=${this.reference_id}&amino_acid_position=${this.amino_acid_position}&mutation=${this.mutation}`
      );
      this.lineagescount = lineagescount;
      const lineagestraindistribution = await axios.get(
        `${process.env.baseUrl}/uniquelineagestrain/?search=${this.search}&start_date=${this.start_date}&end_date=${this.end_date}&strain=${this.strain}&state=${this.state}&lineage=${this.lineage}&mutation_deletion=${this.mutation_deletion}&date=${this.date}&gene=${this.gene}&reference_id=${this.reference_id}&amino_acid_position=${this.amino_acid_position}&mutation=${this.mutation}`
      );
      this.lineagestraindistribution = lineagestraindistribution;

      const Genome_sequenced = await axios.get(
        `${process.env.baseUrl}/genomesseqenced/?search=${this.search}&start_date=${this.start_date}&end_date=${this.end_date}&strain=${this.strain}&state=${this.state}&lineage=${this.lineage}&mutation_deletion=${this.mutation_deletion}&date=${this.date}&gene=${this.gene}&reference_id=${this.reference_id}&amino_acid_position=${this.amino_acid_position}&mutation=${this.mutation}`
      );
      this.Genome_sequenced = Genome_sequenced;
      const mutationdistribution = await axios.get(
        `${process.env.baseUrl}/statesequencesdistribution/?strain=${this.strain}&ordering=${this.ordering}&state=${this.state}&lineage=${this.lineage}&mutation_deletion=${this.mutation_deletion}&date=${this.date}&gene=${this.gene}&reference_id=${this.reference_id}&amino_acid_position=${this.amino_acid_position}&mutation=${this.mutation}`
      );
      mutationdistribution.data.forEach((d) => {
        const { state, strain__count } = d;
      ...
      const data1 = await axios.get(
        `${process.env.baseUrl}/monthlydistribution/?year=${this.year}&strain=${this.strain}&state=${this.state}&lineage=${this.lineage}&mutation_deletion=${this.mutation_deletion}&date=${this.date}&gene=${this.gene}&reference_id=${this.reference_id}&amino_acid_position=${this.amino_acid_position}&mutation=${this.mutation}`
      );
