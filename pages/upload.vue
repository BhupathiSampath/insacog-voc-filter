                    ...
                    <div class="flex flex-col flex-grow mb-3">
                        ...
                        >
                            ...
                            <template x-if="files !== null">
                                <div class="flex flex-col space-y-1">
                                    ...
                                    >
                                        ...
                                        >
                                            <template
                                                x-if="files[index].type.includes('audio/')"
                                                ><i
                                                    class="far fa-file-audio fa-fw"
                                                ></i
                                            ></template>
                                            <template
                                                x-if="files[index].type.includes('application/')"
                                                ><i
                                                    class="far fa-file-alt fa-fw"
                                                ></i
                                            ></template>
                                            <template
                                                x-if="files[index].type.includes('image/')"
                                                ><i
                                                    class="far fa-file-image fa-fw"
                                                ></i
                                            ></template>
                                            <template
                                                x-if="files[index].type.includes('video/')"
                                                ><i
                                                    class="far fa-file-video fa-fw"
                                                ></i
                                            ></template>
                                            <span
                            ...
                            <template x-if="files === null">
                                ...
                                >
                                    <i
                                        class="fas fa-cloud-upload-alt fa-3x text-currentColor"
                                    ></i>
...
export default {
    ...
    methods: {
        submitFile() {
            ...
            this.$axios
                .post('http://10.10.6.87/api/adddata/', formData, {
                    headers: {
