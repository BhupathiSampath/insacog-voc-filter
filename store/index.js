...
export default () => new Vuex.Store({
    ...
    actions: {
        async getPosts({ commit }) {
            ...
            // }
            axios.get(`${process.env.baseUrl}/linclassification/?days=${this.state.days}&amino_acid_position=${this.state.amino_acid_position}&year=${this.state.year}&start_date=${this.state.start_date}&end_date=${this.state.end_date}&strain=${this.state.strain}&state=${this.state.state}&lineage=${this.state.lineage}&mutation_deletion=${this.state.mutation_deletion}&date=${this.state.date}&gene=${this.state.gene}&reference_id=${this.state.reference_id}&mutation=${this.state.mutation}`)
            .then(response => {
                commit('SET_LineageClassification', response.data)
            }),
            axios.get(`${process.env.baseUrl}/data/?page=${this.state.page}&amino_acid_position=${this.state.amino_acid_position}&days=${this.state.days}&year=${this.state.year}&start_date=${this.state.start_date}&end_date=${this.state.end_date}&strain=${this.state.strain}&state=${this.state.state}&lineage=${this.state.lineage}&mutation_deletion=${this.state.mutation_deletion}&date=${this.state.date}&gene=${this.state.gene}&reference_id=${this.state.reference_id}&mutation=${this.state.mutation}`)
                .then(response => {
                    commit('SET_DataTable', response.data)
            })
            axios.get(`${process.env.baseUrl}/lineageclassificationweekly/?days=${this.state.days}&amino_acid_position=${this.state.amino_acid_position}&year=${this.state.year}&start_date=${this.state.start_date}&end_date=${this.state.end_date}&strain=${this.state.strain}&state=${this.state.state}&lineage=${this.state.lineage}&mutation_deletion=${this.state.mutation_deletion}&date=${this.state.date}&gene=${this.state.gene}&reference_id=${this.state.reference_id}&mutation=${this.state.mutation}`)
            .then(response => {
                commit('SET_WeekLineageClassification', response.data)
            }),
            axios.get(`${process.env.baseUrl}/lineageclassificationmonth/?days=${this.state.days}&amino_acid_position=${this.state.amino_acid_position}&year=${this.state.year}&start_date=${this.state.start_date}&end_date=${this.state.end_date}&strain=${this.state.strain}&state=${this.state.state}&lineage=${this.state.lineage}&mutation_deletion=${this.state.mutation_deletion}&date=${this.state.date}&gene=${this.state.gene}&reference_id=${this.state.reference_id}&mutation=${this.state.mutation}`)
            .then(response => {
                commit('SET_MonthLineageClassification', response.data)
            }),
            axios.get(`${process.env.baseUrl}/weeklylineages/?days=${this.state.days}&amino_acid_position=${this.state.amino_acid_position}&year=${this.state.year}&strain=${this.state.strain}&start_date=${this.state.start_date}&end_date=${this.state.end_date}&state=${this.state.state}&lineage=${this.state.lineage}&mutation_deletion=${this.state.mutation_deletion}&date=${this.state.date}&gene=${this.state.gene}&reference_id=${this.state.reference_id}&mutation=${this.state.mutation}`)
                .then(response => {
                    commit('SET_weeklyLineages', response.data)
            }),
            axios.get(`${process.env.baseUrl}/distribution/?days=${this.state.days}&amino_acid_position=${this.state.amino_acid_position}&year=${this.state.year}&strain=${this.state.strain}&start_date=${this.state.start_date}&end_date=${this.state.end_date}&state=${this.state.state}&lineage=${this.state.lineage}&mutation_deletion=${this.state.mutation_deletion}&date=${this.state.date}&gene=${this.state.gene}&reference_id=${this.state.reference_id}&mutation=${this.state.mutation}`)
                .then(response => {
                    commit('SET_WeekDistribution', response.data)
            }),
            axios.get(`${process.env.baseUrl}/monthlydistribution/?days=${this.state.days}&amino_acid_position=${this.state.amino_acid_position}&year=${this.state.year}&start_date=${this.state.start_date}&end_date=${this.state.end_date}&strain=${this.state.strain}&state=${this.state.state}&lineage=${this.state.lineage}&mutation_deletion=${this.state.mutation_deletion}&date=${this.state.date}&gene=${this.state.gene}&reference_id=${this.state.reference_id}&mutation=${this.state.mutation}`)
                .then(response => {
                    commit('SET_MonthDistribution', response.data)
            }),
            
            axios.get(`${process.env.baseUrl}/stateslineageclassification/?days=${this.state.days}&amino_acid_position=${this.state.amino_acid_position}&year=${this.state.year}&start_date=${this.state.start_date}&end_date=${this.state.end_date}&strain=${this.state.strain}&state=${this.state.state}&lineage=${this.state.lineage}&mutation_deletion=${this.state.mutation_deletion}&date=${this.state.date}&gene=${this.state.gene}&reference_id=${this.state.reference_id}&mutation=${this.state.mutation}`)
                .then(response => {
                    commit('SET_StateLineageClassification', response.data)
            }),
            axios.get(`${process.env.baseUrl}/statesequencesdistribution/?days=${this.state.days}&amino_acid_position=${this.state.amino_acid_position}&year=${this.state.year}&start_date=${this.state.start_date}&end_date=${this.state.end_date}&strain=${this.state.strain}&state=${this.state.state}&lineage=${this.state.lineage}&mutation_deletion=${this.state.mutation_deletion}&date=${this.state.date}&gene=${this.state.gene}&reference_id=${this.state.reference_id}&mutation=${this.state.mutation}`)
                .then(response => {
                    commit('SET_StateDistribution', response.data)
            }),
            axios.get(`${process.env.baseUrl}/uniqelineagecount/?days=${this.state.days}&amino_acid_position=${this.state.amino_acid_position}&year=${this.state.year}&start_date=${this.state.start_date}&end_date=${this.state.end_date}&strain=${this.state.strain}&state=${this.state.state}&lineage=${this.state.lineage}&mutation_deletion=${this.state.mutation_deletion}&date=${this.state.date}&gene=${this.state.gene}&reference_id=${this.state.reference_id}&mutation=${this.state.mutation}`)
                .then(response => {
                    commit('SET_UniqueLineages', response.data)
            }),
            axios.get(`${process.env.baseUrl}/uniquelineagestrain/?days=${this.state.days}&amino_acid_position=${this.state.amino_acid_position}&year=${this.state.year}&start_date=${this.state.start_date}&end_date=${this.state.end_date}&strain=${this.state.strain}&state=${this.state.state}&lineage=${this.state.lineage}&mutation_deletion=${this.state.mutation_deletion}&date=${this.state.date}&gene=${this.state.gene}&reference_id=${this.state.reference_id}&mutation=${this.state.mutation}`)
                .then(response => {
                    commit('SET_LineageDistribution', response.data)
            }),
            axios.get(`${process.env.baseUrl}/genomesseqenced/?days=${this.state.days}&amino_acid_position=${this.state.amino_acid_position}&start_date=${this.state.start_date}&end_date=${this.state.end_date}&year=${this.state.year}&strain=${this.state.strain}&state=${this.state.state}&lineage=${this.state.lineage}&mutation_deletion=${this.state.mutation_deletion}&date=${this.state.date}&gene=${this.state.gene}&reference_id=${this.state.reference_id}&mutation=${this.state.mutation}`)
                .then(response => {
